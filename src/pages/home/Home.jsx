      ...
      <div className="home section">
        <div className="home__container container">
          <div className="homeLeft">
            ...
            <Link to="/products" className="button home__btn">
              shop now
            </Link>
          </div>
          <div className="homeRight">
            <img src="/hero-img.png" alt="" className="homeImg" />
          </div>
        </div>
        <div className="trendingProducts section">
          <div className="trending__container container">
            <h1 className="section__title">Trending Products</h1>
            <div className="trendingImgCon grid">
              {products
                .filter((product) => product.category === "chair")
                .map((item) => {
                  return (
                    <article key={item.id} className="homeItem">
                      <p className="item__img">
                        <img src={item.imgUrl} alt="" className="productImg" />
            ...
            <Link to="/products" className="button home__btn  trendingBtn">
              all products
            </Link>
          </div>
        </div>
        <div className="home__bottom section">
          <div className="home__botton-container container">
            <div className="home__bottom-text">
              <h1 className="home__bottom-title">
                Custom Furniture <br />
                Built Only For You
              </h1>
              <p>
            ...
            <div className="company__desc grid">
              <p className="home__box">
                <span className="home__svg">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
                    stroke-width="0"
